                        ...
                        <div class="blog-main-box blog-details">
                            <div>
                                <div class="blog-img"> <img class="img-fluid bg-img"
                                        src="{{asset('assets/front/images/other-img/blog-details.jpg')}}" alt=""></div>
                            </div>
                            <div class="blog-content"><span class="blog-date">May 9, 2018 Stylish </span><a href="#">
                                ...
                                <p>Sed non mauris vitae erat consequat. Proin gravida nibh vel velit auctor aliquet.
                                    ...
                                    more.</span>
                                <span class="mt-0">I had low expectations about Sofia as a city, but after the
                            ...
                            <div class="sidebar-box">
                                ...
                                <ul class="top-post">
                                    <li> <img class="img-fluid"
                                            src="{{asset('assets/front/images/other-img/blog-1.jpg')}}" alt="">
                                    ...
                                    <li> <img class="img-fluid"
                                            src="{{asset('assets/front/images/other-img/blog-2.jpg')}}" alt="">
                                        <div> <a href="blog-details.html">
                                    ...
                                    <li> <img class="img-fluid"
                                            src="{{asset('assets/front/images/other-img/blog-3.jpg')}}" alt="">
                                        <div> <a href="blog-details.html">
                                    ...
                                    <li> <img class="img-fluid"
                                            src="{{asset('assets/front/images/other-img/blog-4.jpg')}}" alt="">
                                        <div> <a href="blog-details.html">
